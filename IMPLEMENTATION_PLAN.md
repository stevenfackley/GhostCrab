...
| 12 | Skills-Install (WS-backed) | 🟡 On-device QA ready | 2026-04-18 | 2026-04-19 | f73213e | Opus 4.7 | InstalledSkillRepositoryImpl over GatewayWsClient (JSON-RPC 2.0); skills.list/install/uninstall + skills.install.progress notifs; InstalledSkillsScreen + VM; scope probe via auth.whoami → operator.admin gate for AI Recommend install button; SKILLS_INSTALL_ENABLED BuildConfig flag (true debug / false release). All unit tests green. Mock gateway added 2026-04-21 — host smoke-test passed 2026-04-22 (all 5 WS methods: whoami/list/install+progress/uninstall). **Connect device to http://&lt;LAN-IP&gt;:18790 and QA the Skills screen to close this phase.** |
