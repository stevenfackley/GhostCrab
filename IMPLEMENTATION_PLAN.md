...
| 10 | Hardening: Tests, Crash Handling, Telemetry, Release | 🟢 Done | 2026-04-16 | 2026-04-16 | — | Sonnet 4.6 | PrivacySafeUncaughtExceptionHandler; LeakCanary debug dep; complete ProGuard rules; release signing (env vars); 4 ADRs (0001–0004); CHANGELOG v0.1.0; +22 unit tests (ConnectionPickerVM×7, ManualEntryVM×8, ConfigRepositoryImpl×4, CrashHandler×3) |
